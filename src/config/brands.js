...
module.exports = [
  {
    id: 'brand1',
    name: process.env.BRAND1_NAME || 'Brand 1',
    ...
    lpRepoPrefix: process.env.BRAND1_LP_PREFIX || 'lp-brand1-'
  },
  {
    id: 'brand2',
    name: process.env.BRAND2_NAME || 'Brand 2',
    ...
    lpRepoPrefix: process.env.BRAND2_LP_PREFIX || 'lp-brand2-'
  }
];
